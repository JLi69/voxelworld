...
pub fn get_check_valid_fn(block: u8) -> Option<fn(&World, i32, i32, i32) -> bool> {
    match block {
        //Sapling, Grass, and Flowers
        47 | 49 | 54..=56 => Some(|world, x, y, z| {
            check_below_valid(world, x, y, z, &[ 1, 4, 17 ])
        }),
        //Mushroom
        48 => Some(|world, x, y, z| {
            let below = world.get_block(x, y - 1, z);
        ...
        //Wheat
        50..=53 => Some(|world, x, y, z| {
            check_below_valid(world, x, y, z, &[ 43, 45 ])
        }),
        //Sugar cane
        69 => Some(|world, x, y, z| {
            check_below_valid(world, x, y, z, &[ 1, 4, 11, 17, 69 ])
        }),
        _ => None,
    }
}
